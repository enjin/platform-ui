                            ...
                            <template #inputs="{ inputs, index }">
                                <div class="w-1/2">
                                    <input
                                        ...
                                        class="block w-full rounded-md border-0 py-2 text-light-content-strong dark:text-dark-content-strong shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-light-content dark:text-dark-content focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6"
                                    />
                                </div>
                                <div class="w-1/2">
